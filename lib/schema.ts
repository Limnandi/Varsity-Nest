...
export const accommodations = pgTable("accommodations", {
  ...
  isVerified: boolean("is_verified").default(false),
  hasSingleRooms: boolean("has_single_rooms").default(false),
  hasSharingRooms: boolean("has_sharing_rooms").default(false),
  singleRoomPrice: decimal("single_room_price", { precision: 10, scale: 2 }),
  sharingRoomPrice: decimal("sharing_room_price", { precision: 10, scale: 2 }),
  singleRoomsTotal: integer("single_rooms_total").default(0),
  singleRoomsAvailable: integer("single_rooms_available").default(0),
  sharingRoomsTotal: integer("sharing_rooms_total").default(0),
  sharingRoomsAvailable: integer("sharing_rooms_available").default(0),
  city: varchar("city", { length: 100 }),
  province: varchar("province", { length: 100 }),
  postalCode: varchar("postal_code", { length: 20 }),
