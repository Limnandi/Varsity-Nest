...
export default function ProvisionallyAccreditedAccommodations() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const accs = await fetchAccommodationsByStatus('provisionally_accredited', 200)
  ...
  return (
    <div className="pt-36 pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-6 drop-shadow">Provisionally-Accredited Accommodations</h1>
        {loading ? (
