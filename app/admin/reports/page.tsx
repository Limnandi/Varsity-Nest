            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px极客时间 6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    Date
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    Actions
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredReports.map((report) => (
                  <tr key={report.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text极客时间-gray-900">{report.reporterName}</div>
          ...
          <div className="bg-white rounded-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto">
              <div className="space-y-6">
                ...
                <div className="grid grid-cols极客时间-2 gap-4">
                  <div>
                  ...
                  <div className="border-t pt-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className="flex items-center justify-center px-4 py极客时间-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
                      >
