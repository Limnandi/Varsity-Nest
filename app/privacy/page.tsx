          ...
          <div className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-white shadow-2xl shadow-blue-500/10 hover:shadow-blue-500/20 transition-all duration-300">
            <div className="prose prose-invert max-w-none">
              <p className="text-neutral-300 text-lg mb-8">
                At Varsity Nest, we are committed to protecting your privacy and ensuring that your personal information is used responsibly. This Privacy Policy outlines how we collect, use, and protect the personal information of users who access or use our services.
              </p>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">1. Information We Collect</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">2. How We Use Your Information</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">3. Data Protection & Security</h2>
                ...
                <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-blue-400 mb-2">GDPR Compliance:</h3>
                  <p className="text-neutral-300">
                    We are committed to complying with applicable data protection laws, including the General Data Protection Regulation (GDPR). We process your personal data lawfully, fairly, and transparently, and only for specified, explicit, and legitimate purposes.
                  </p>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">4. Data Sharing and Disclosure</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
                ...
                <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4 mt-4">
                  <h3 className="text-lg font-semibold text-yellow-400 mb-2">Third-Party Services:</h3>
                  <p className="text-neutral-300">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">5. Cookies and Tracking Technologies</h2>
                <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-purple-400 mb-2">Cookie Usage:</h3>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">6. Your Data Rights</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">7. Data Retention</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">9. International Data Transfers</h2>
                <p className="text-neutral-300 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">10. Third-Party Websites</h2>
                <p className="text-neutral-300 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">12. Contact Us</h2>
                <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-6">
                  <p className="text-neutral-300 mb-4">
                    If you have any questions or concerns about this Privacy Policy or how we handle your personal information, please contact us at:
                  </p>
                  <div className="space-y-2">
                    <p className="text-blue-300 font-medium">Email: support@varsitynest.co.za</p>
                    <p className="text-blue-300 font-medium">Phone: +27 62 407 9139</p>
                    <p className="text-blue-300 font-medium">Address: Bloemfontein, 9300, South Africa</p>
                  </div>
                </div>
              </section>
            </div>
