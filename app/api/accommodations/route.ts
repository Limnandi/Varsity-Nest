...
export async function POST(request: NextRequest) {
  try {
    ...
    if (contentType.includes('multipart/form-data')) {
      ...
      single_rooms_total: Number(form.get('single_rooms_total') || 0),
      single_rooms_available: Number(form.get('single_rooms_available') || 0),
      sharing_rooms_total: Number(form.get('sharing_rooms_total') || 0),
      sharing_rooms_available: Number(form.get('sharing_rooms_available') || 0),
      ...
      const jsonData = {
        ...
        single_rooms_total: raw.single_rooms_total != null ? Number(raw.single_rooms_total) : undefined,
        single_rooms_available: raw.single_rooms_available != null ? Number(raw.single_rooms_available) : undefined,
        sharing_rooms_total: raw.sharing_rooms_total != null ? Number(raw.sharing_rooms_total) : undefined,
        sharing_rooms_available: raw.sharing_rooms_available != null ? Number(raw.sharing_rooms_available) : undefined,
    ...
    const record = await insertAccommodation({
      ...
      single_rooms_total: Number(payload.single_rooms_total) || 0,
      single_rooms_available: Number(payload.single_rooms_available) || 0,
      sharing_rooms_total: Number(payload.sharing_rooms_total) || 0,
      sharing_rooms_available: Number(payload.sharing_rooms_available) || 0,
