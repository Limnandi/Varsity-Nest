          ...
          <div className="relative border border-white/10 bg-black/20 backdrop-blur-xl rounded-2xl p-4 sm:p-6 lg:p-8 shadow-2xl shadow-blue-500/20">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="min-w-0 flex-1">
                ...
                <p className="text-neutral-300 text-sm sm:text-lg break-words">Manage your property listings</p>
              </div>
            </div>
          </div>
              ...
              {userAccommodations.map((accommodation) => (
                <div key={accommodation.id} className={`relative border border-white/10 rounded-xl shadow-xl overflow-hidden hover:shadow-blue-500/20 transition-all duration-300 ${
                  ...
                  <div className="p-3 sm:p-4 text-white relative">
                    <h3 className="text-base sm:text-lg font-semibold mb-2 text-white line-clamp-1 break-words min-w-0">{accommodation.name}</h3>

                    {accommodation.managed_by_provider_name && (
                      <div className="flex items-center text-neutral-300 text-xs mb-2 bg-blue-500/10 border border-blue-500/30 rounded-lg px-2 py-1 break-words min-w-0">
                        <UserCheck className="w-3.5 h-3.5 mr-2 text-blue-400 flex-shrink-0" />
                        <span className="break-words">Managed by {accommodation.managed_by_provider_name}</span>
                      </div>
                    )}
                    ...
                    <div className="flex items-center text-neutral-300 text-xs mb-2 min-w-0">
                      ...
                      <span className="break-words truncate">{accommodation.address}</span>
                    </div>
                    ...
                    <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4">
                      <div className="flex items-center gap-2 sm:gap-3">
                        <label className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-neutral-300 break-words">
                          <input 
                            type="checkbox" 
                            checked={Boolean(accommodation.featured)} 
                            onChange={(e) => handleToggleFeatured(accommodation.id, e.target.checked)}
                            className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600 bg-black/20 border-white/20 rounded focus:ring-blue-500 flex-shrink-0"
                          />
                      ...
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                        ...
                        <input 
                          type="number" 
                          className="w-16 sm:w-20 px-2 sm:px-3 py-1.5 sm:py-2 bg-black/20 border border-white/20 rounded-lg text-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-0" 
                    ...
                    <div className="space-y-2">
                      <button
                        ...
                        className={`w-full px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg transition-all duration-300 text-center flex items-center justify-center gap-1.5 sm:gap-2 font-semibold cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed text-xs sm:text-sm break-words ${
                      ...
                      <div className="flex flex-wrap gap-2">
                        {accommodation.is_published && (
                          <Link
                            ...
                            className="flex-1 min-w-[80px] bg-white/10 text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg hover:bg-white/20 transition-all duration-300 text-center flex items-center justify-center gap-1.5 sm:gap-2 border border-white/20 text-xs sm:text-sm break-words"
                          >
                        ...
                        <Link
                          ...
                          className="flex-1 min-w-[80px] bg-gradient-to-r from-blue-600 to-purple-600 text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 text-center flex items-center justify-center gap-1.5 sm:gap-2 shadow-lg shadow-blue-500/20 text-xs sm:text-sm break-words"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 min-w-[80px] bg-gradient-to-r from-red-600 to-red-700 text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg hover:from-red-700 hover:to-red-800 transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 shadow-lg shadow-red-500/20 text-xs sm:text-sm break-words"
                        >
