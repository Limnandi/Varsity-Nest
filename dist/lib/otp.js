        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    otp = generateOTP();
                    // Store OTP in Redis
                    return [4 /*yield*/, (0, redis_1.storeOTP)(email, otp, type)];
                case 1:
                    // Store OTP in Redis
                    _a.sent();
...
function verifyOTP(email_1, inputOTP_1) {
    return __awaiter(this, arguments, void 0, function (email, inputOTP, type) {
        var redis, storedOTP, attempts, error_2;
        if (type === void 0) { type = "registration"; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 11, , 12]);
                    return [4 /*yield*/, import("./redis.js")];
                case 1:
                    redis = (_a.sent()).redis;
                    return [4 /*yield*/, redis.get("otp:".concat(type, ":").concat(email))];
                case 2:
                    storedOTP = _a.sent();
                    if (!storedOTP) {
                        return [2 /*return*/, { success: false, error: "OTP has expired or doesn't exist" }];
                    }
                    return [4 /*yield*/, redis.get("otp:".concat(type, ":").concat(email, ":attempts"))];
                case 3:
                    attempts = (_a.sent()) || "0";
                    if (!(Number.parseInt(attempts) >= 3)) return [3 /*break*/, 6];
                    return [4 /*yield*/, redis.del("otp:".concat(type, ":").concat(email))];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, redis.del("otp:".concat(type, ":").concat(email, ":attempts"))];
                case 5:
                    _a.sent();
                    return [2 /*return*/, { success: false, error: "Too many failed attempts. Please request a new code." }];
                case 6:
                    if (!(storedOTP !== inputOTP)) return [3 /*break*/, 8];
                    return [4 /*yield*/, redis.incr("otp:".concat(type, ":").concat(email, ":attempts"))];
                case 7:
                    _a.sent();
