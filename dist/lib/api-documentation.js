...
var ApiDocumentation = /** @class */ (function () {
    function ApiDocumentation() {
    }
    /**
     * Register an API endpoint
     */
    ApiDocumentation.registerEndpoint = function (endpoint) {
        var key = "".concat(endpoint.method, ":").concat(endpoint.path, ":").concat(endpoint.version);
        this.endpoints.set(key, endpoint);
    };
    /**
     * Get all registered endpoints
     */
    ApiDocumentation.getAllEndpoints = function () {
        return Array.from(this.endpoints.values());
    };
    /**
     * Get endpoints by version
     */
    ApiDocumentation.getEndpointsByVersion = function (version) {
        return this.getAllEndpoints().filter(function (ep) { return ep.version === version; });
    };
    /**
     * Get endpoint documentation
     */
    ApiDocumentation.getEndpoint = function (method, path, version) {
        var key = "".concat(method, ":").concat(path, ":").concat(version);
        return this.endpoints.get(key);
    };
    /**
     * Generate API specification in JSON format
     */
    ApiDocumentation.generateApiSpec = function () {
     ...
     */
    ApiDocumentation.generateEndpointsDocumentation = function (endpoints) {
        return endpoints.map(function (endpoint) {
            ...
            return ({
                ...
                parameters: ((_a = endpoint.parameters) === null || _a === void 0 ? void 0 : _a.map(function (param) { return ({
                    name: param.name,
                ...
                responses: endpoint.responses.map(function (response) { return ({
     ...
     */
    ApiDocumentation.generateSchemas = function () {
        return {
            Error: {
                type: 'object',
                properties: {
     ...
     */
    ApiDocumentation.initializeDocumentation = function () {
     ...
     */
    ApiDocumentation.createEndpointDoc = function (method, path, version, description) {
        ...
        return {
            ...
            setRateLimit: function (windowMs, max) {
                this.rateLimit = { windowMs: windowMs, max: max };
                return this;
            },
            setAuthentication: function (required, roles) {
                this.authentication = { required: required, roles: roles };
                return this;
            },
            register: function () {
                ApiDocumentation.registerEndpoint(this);
                return this;
            }
        };
    };
    ApiDocumentation.endpoints = new Map();
