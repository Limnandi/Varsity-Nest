...
describe('env module', () => {
  it('should validate required environment variables', async () => {
    ...
    process.env.PAYFAST_MERCHANT_ID = process.env.PAYFAST_MERCHANT_ID || 'test'
    process.env.PAYFAST_MERCHANT_KEY = process.env.PAYFAST_MERCHANT_KEY || 'test'
    process.env.PAYFAST_PASSPHRASE = process.env.PAYFAST_PASSPHRASE || 'test'
